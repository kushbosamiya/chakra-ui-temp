...
const Homeopathy = () => {
  ...
  async function fetchPosts() {
    const { data } = await supabase.from("Homeopathy_Docs");
    let Cdata = [];
  ...
  // const Expirience = ["5.6", "8", "6", "9.6", "15", "10", "5"];
  // const getExpirience =
  //   Expirience[Math.floor(Math.random() * Expirience.length)];
              ...
              <>
                <li key={item.id}>
                  ...
                  >
                    ...
                    <Divider />
                    <GridItem pt=".5rem">
                      <Text color="#424b5a">{item.symtoms}</Text>
                    </GridItem>
                    <GridItem pt=".5rem">
                      <Grid
        ...
        >
          ...
          <Box px="1rem" w="800%">
            <Input
              ...
              fontSize="1rem"
              h="1.5rem"
              placeholder="Search for homeopathic Doctors "
            />
          </Box>
        </InputGroup>
      </Box>
